...
<!DOCTYPE stylesheet [
    ...
    <!ENTITY ti "http://vocab.lodum.de/pres#">
    <!--<!ENTITY tis "http://www.ontologydesignpatterns.org/cp/owl/timeindexedsituation.owl#">-->
     <!ENTITY tis "http://vocab.lodum.de/pres#">
    <!ENTITY pres "http://vocab.lodum.de/pres#">
			...
			<xsl:choose>
				...
				<xsl:when test="number(string-length(string($data)))=7">
						...
						<call-template name="krextor:create-resource">
		            		...
		            		<with-param name="related-via-properties" select="'&pres;eventTime'" tunnel="yes" />
		        		</call-template>	
		    	</xsl:when>
